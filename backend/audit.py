...
class AuditEventType:
    ...
    AI_VERSION_COMPARISON_GENERATED = "AI_VERSION_COMPARISON_GENERATED"
    AI_VERSION_COMPARISON_FAILED = "AI_VERSION_COMPARISON_FAILED"
    AI_TIMELINE_GENERATED = "AI_TIMELINE_GENERATED"
    AI_TIMELINE_GENERATION_FAILED = "AI_TIMELINE_GENERATION_FAILED"
